//
//  SelectProfileImageController+TLPickerDelegate.swift
//  CanLove
//
...
extension SelectProfileImageController:TLPhotosPickerViewControllerDelegate{
    ...
    func dismissPhotoPicker(withTLPHAssets: [TLPHAsset]) {
        ...
        for asset in assets {
            ...
            imageManager.requestImage(for: asset, targetSize: targetSize, contentMode: PHImageContentMode.aspectFit, options: options) { (receivedImage, info) in
                ...
                weak.selectedImage = image
                DispatchQueue.main.async {
                    weak.performSegue(withIdentifier: K.segues.auth.selectProfileControllerToAboutPetController, sender: weak)
                }
            }
        }
